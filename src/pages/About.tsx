    ...
    return (
        <PageContainer>
            <Card>
                ...
                <Text> <span> ✔️ </span>На данный момент обучаюсь на 3 курсе по направлению "Системное программирование",ИМКТ,ДВФУ </Text>
                <Text> <span> ✔️ </span>Дополнительно обучаюсь на цифровых кафедрах по направлению "Разработка мобильных приложений на Android"</Text>
